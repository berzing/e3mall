...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="方寒"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="13476283007"/>
	<input type="hidden" name="orderShipping.receiverState" value="湖北"/>
	<input type="hidden" name="orderShipping.receiverCity" value="武汉"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="江岸区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="湖大知行学院"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>方寒&nbsp;&nbsp;&nbsp;&nbsp;13476283007&nbsp;&nbsp;&nbsp;&nbsp;武汉&nbsp;&nbsp;江岸区&nbsp;&nbsp;湖大知行学院</li>
          </ul>
        </div>
    </div>
  </div>
